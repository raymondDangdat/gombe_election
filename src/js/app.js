...
App = {
  web3Provider: null,
  contracts: {},
  // account: 0x1a167830868db85a6ce523BED22099D7d91f0504,
  account:0x0,
  ...
  initWeb3: async function() {
    console.log("Function to initWeb3 called:::::::::::::::::::::::");
    if (window.ethereum) {
      try {
        window.ethereum.enable();
        const accounts = await window.ethereum.request({ method: 'eth_requestAccounts' });
        setAccounts(accounts);
        console.log("Account Initiated:::: " + accounts)
      } catch (error) {
        console.log("Error Initializing Web3:::::::::" + error.code);
        if (error.code === 4001) {
  ...
  addCandidate: function(){
    ...
    App.contracts.Contest.deployed().then(function(instance) {
      ...
      return instance.addContestant(name, party, age, qualification, { from: web3.eth.accounts[0] });
    }).then(function(result) {
      console.log("Transaction successful:", result);
      $("#loader").show(); // Show the loader after transaction is sent
  ...
  changeState: function(){
    console.log("changeState method called=========");
    phaseEnum ++;
